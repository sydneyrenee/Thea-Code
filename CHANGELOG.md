...
- Support project-level MCP config in .thea/mcp.json (thanks @aheizi!)
...
- Add an activation command that other extensions can use to interface with Thea Code (thanks @gtaylor!)
...
- Pass current language to system prompt correctly so Thea thinks and speaks in the selected language

## [3.9.0] - 2025-03-18

- Internationalize Thea Code into Catalan, German, Spanish, French, Hindi, Italian, Japanese, Korean, Polish, Portuguese, Turkish, Vietnamese, Simplified Chinese, and Traditional Chinese (thanks @feifei325!)
- Bring back support for MCP over SSE (thanks @aheizi!)
- Add a text-to-speech option to have Thea talk to you as it works (thanks @heyseth!)
...
- Fix wheel scrolling when Thea is opened in editor tabs (thanks @GitlyHallows!)
- Don’t automatically mention the file when using the "Add to context" code action (thanks @qdaxb!)
- Expose task stack in `TheaCodeAPI` (thanks @franekp!)
...
- Add an option in the prompts tab to save tokens by disabling the ability to ask Thea to create/edit custom modes for you (thanks @hannesrudolph!)
...
- Add opt-in telemetry to help us improve Thea Code faster (thanks Cline!)
...
- Add support for a .thea_ignore to prevent Thea Code from read/writing certain files, with a setting to also exclude them from search/lists (thanks Cline!)
...
- Support running Thea in multiple editor windows simultaneously (thanks @samhvw8!)
...
- Add a new “Human Relay” provider that allows you to manually copy information to a Web AI when needed, and then paste the AI's response back into Thea Code (thanks @NyxJae)!
...
- Fix context window truncation math (see [#1173](sydneyrenee/Thea-Code/issues/1173))
...
- Introducing Thea Code 3.7, with support for the new Claude Sonnet 3.7. Because who cares about skipping version numbers anymore? Thanks @lupuletic and @cte for the PRs!
...
- Fix a bug where the .thea_modes file was not automatically created when adding custom modes from the Prompts tab
...
- Fix system prompt to make sure Thea knows about all available modes
- Enable streaming mode for OpenAI o1

## [3.3.20] - 2025-02-14

- Support project-specific custom modes in a .thea_modes file
...
- Prompt tweaks to make Thea better at creating new custom modes for you

## [3.3.6]

- Add a "new task" tool that allows Thea to start new tasks with an initial message and mode
...
- New Thea Code community Discord at https://thea-code.com/discord!
...
- **Name Change From Thea Cline to Thea Code:** We're excited to announce our new name! After growing beyond 50,000 installations, we've rebranded from Thea Cline to Thea Code to better reflect our identity as we chart our own course.

- **Custom Modes:** Create your own personas for Thea Code! While our built-in modes (Code, Architect, Ask) are still here, you can now shape entirely new ones:
...
Join us at https://www.reddit.com/r/thea-placeholder to share your custom modes and be part of our next chapter!
...
- This release adds chat modes! Now you can ask Thea Code questions about system architecture or the codebase without immediately jumping into writing code. You can even assign different API configuration profiles to each mode if you prefer to use different models for thinking vs coding. Would love feedback in the new Thea Code Reddit! https://www.reddit.com/r/thea-placeholder
...
- Incorporate Premshay's [PR](https://github.com/sydneyrenee/Thea-Code/pull/60) to add support for Amazon Nova and Meta Llama Models via Bedrock (3, 3.1, 3.2) and unified Bedrock calls using BedrockClient and Bedrock Runtime API
...
- Incorporate dbasclpy's [PR](https://github.com/sydneyrenee/Thea-Code/pull/54) to add support for gemini-exp-1206
...
- Fix https://github.com/sydneyrenee/Thea-Code/issues/50 where sound effects were not respecting settings
...
- Incorporate lloydchang's [PR](https://github.com/sydneyrenee/Thea-Code/pull/42) to add support for OpenRouter compression
...
- Thea Cline now allows configuration of which commands are allowed without approval!
...
- Thea Cline now runs in all VSCode-compatible editors
...
- Thea Cline now can run side-by-side with Cline

## [2.1.3]

- Thea Cline now allows browser actions without approval when `alwaysAllowBrowser` is true
