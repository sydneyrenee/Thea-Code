...
<br>
<div align="center">
  <h2>Tham Gia Cộng Đồng Thea Code</h2>
  <p>Kết nối với các nhà phát triển, đóng góp ý tưởng và cập nhật với các công cụ lập trình mới nhất được hỗ trợ bởi AI.</p>
  
  <a href="https://discord.gg/thea-placeholder" target="_blank"><img src="https://img.shields.io/badge/Tham%20gia%20Discord-5865F2?style=for-the-badge&logo=discord&logoColor=white" alt="Tham gia Discord"></a>
  <a href="https://www.reddit.com/r/thea-placeholder/" target="_blank"><img src="https://img.shields.io/badge/Tham%20gia%20Reddit-FF4500?style=for-the-badge&logo=reddit&logoColor=white" alt="Tham gia Reddit"></a>
...
<div align="center">
<h1>Thea Code (trước đây là Thea Cline)</h1>

<a href="https://marketplace.visualstudio.com/items?itemName=SolaceHarmony.thea-code" target="_blank"><img src="https://img.shields.io/badge/Tải%20từ%20VS%20Marketplace-blue?style=for-the-badge&logo=visualstudiocode&logoColor=white" alt="Tải từ VS Marketplace"></a>
<a href="sydneyrenee/Thea-Code/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop" target="_blank"><img src="https://img.shields.io/badge/Yêu%20cầu%20tính%20năng-yellow?style=for-the-badge" alt="Yêu cầu tính năng"></a>
<a href="https://marketplace.visualstudio.com/items?itemName=SolaceHarmony.thea-code&ssr=false#review-details" target="_blank"><img src="https://img.shields.io/badge/Đánh%20giá%20%26%20Nhận%20xét-green?style=for-the-badge" alt="Đánh giá & Nhận xét"></a>
<a href="https://docs.thea-placeholder.com" target="_blank"><img src="https://img.shields.io/badge/Tài%20liệu-6B46C1?style=for-the-badge&logo=readthedocs&logoColor=white" alt="Tài liệu"></a>

</div>

**Thea Code** là một **tác nhân lập trình tự trị** được hỗ trợ bởi AI sống trong trình soạn thảo của bạn. Nó có thể:
...
Cho dù bạn đang tìm kiếm một đối tác lập trình linh hoạt, một kiến trúc sư hệ thống, hay các vai trò chuyên biệt như kỹ sư QA hoặc quản lý sản phẩm, Thea Code có thể giúp bạn xây dựng phần mềm hiệu quả hơn.

Kiểm tra [CHANGELOG](../CHANGELOG.md) để biết thông tin chi tiết về các cập nhật và sửa lỗi.

---

## 🎉 Đã Phát Hành Thea Code 3.10

Thea Code 3.10 mang đến những cải tiến năng suất mạnh mẽ!
...
1. [Cài đặt Thea Code](https://docs.thea-placeholder.com/getting-started/installing)
2. [Kết nối Nhà cung cấp AI của bạn](https://docs.thea-placeholder.com/getting-started/connecting-api-provider)
3. [Thử tác vụ đầu tiên của bạn](https://docs.thea-placeholder.com/getting-started/your-first-task)

## Tính Năng Chính

### Nhiều Chế Độ

Thea Code thích ứng với nhu cầu của bạn với các [chế độ](https://docs.thea-placeholder.com/basic-usage/using-modes) chuyên biệt:
...
- **[Chế độ tùy chỉnh](https://docs.thea-placeholder.com/advanced-usage/custom-modes):** Tạo vô số nhân vật chuyên biệt cho kiểm toán bảo mật, tối ưu hóa hiệu suất, tài liệu, hoặc bất kỳ tác vụ nào khác

### Công Cụ Thông Minh

Thea Code đi kèm với các [công cụ](https://docs.thea-placeholder.com/basic-usage/how-tools-work) mạnh mẽ có thể:

- Đọc và ghi tập tin trong dự án của bạn
- Thực thi các lệnh trong terminal VS Code của bạn
- Điều khiển trình duyệt web
- Sử dụng công cụ bên ngoài thông qua [MCP (Model Context Protocol)](https://docs.thea-placeholder.com/advanced-usage/mcp)

MCP mở rộng khả năng của Thea Code bằng cách cho phép bạn thêm vô số công cụ tùy chỉnh. Tích hợp với API bên ngoài, kết nối với cơ sở dữ liệu, hoặc tạo các công cụ phát triển chuyên biệt - MCP cung cấp khung để mở rộng chức năng của Thea Code để đáp ứng nhu cầu cụ thể của bạn.

### Tùy Chỉnh

Làm cho Thea Code hoạt động theo cách của bạn với:

- [Hướng dẫn tùy chỉnh](https://docs.thea-placeholder.com/advanced-usage/custom-instructions) cho hành vi cá nhân hóa
- [Chế độ tùy chỉnh](https://docs.thea-placeholder.com/advanced-usage/custom-modes) cho các tác vụ chuyên biệt
- [Mô hình cục bộ](https://docs.thea-placeholder.com/advanced-usage/local-models) cho sử dụng ngoại tuyến
- [Cài đặt tự động phê duyệt](https://docs.thea-placeholder.com/advanced-usage/auto-approving-actions) cho quy trình làm việc nhanh hơn

## Tài Nguyên

### Tài Liệu

- [Hướng Dẫn Sử Dụng Cơ Bản](https://docs.thea-placeholder.com/basic-usage/the-chat-interface)
- [Tính Năng Nâng Cao](https://docs.thea-placeholder.com/advanced-usage/auto-approving-actions)
- [Câu Hỏi Thường Gặp](https://docs.thea-placeholder.com/faq)

### Cộng Đồng

- **Discord:** [Tham gia máy chủ Discord của chúng tôi](https://discord.gg/thea-placeholder) để được trợ giúp và thảo luận trong thời gian thực
- **Reddit:** [Ghé thăm subreddit của chúng tôi](https://www.reddit.com/r/thea-placeholder) để chia sẻ kinh nghiệm và mẹo
- **GitHub:** [Báo cáo vấn đề](sydneyrenee/Thea-Code/issues) hoặc [yêu cầu tính năng](sydneyrenee/Thea-Code/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop)
...
**Xin lưu ý** rằng Solace Project**không** đưa ra bất kỳ tuyên bố hoặc bảo đảm nào liên quan đến bất kỳ mã, mô hình, hoặc công cụ khác được cung cấp hoặc cung cấp liên quan đến Thea Code, bất kỳ công cụ bên thứ ba liên quan, hoặc bất kỳ đầu ra nào. Bạn chịu **tất cả rủi ro** liên quan đến việc sử dụng bất kỳ công cụ hoặc đầu ra như vậy; các công cụ đó được cung cấp trên cơ sở **"NGUYÊN TRẠNG"** và **"NHƯ CÓ SẴN"**. Những rủi ro đó có thể bao gồm, không giới hạn, vi phạm sở hữu trí tuệ, lỗ hổng mạng hoặc tấn công, thành kiến, không chính xác, lỗi, khiếm khuyết, virus, thời gian ngừng hoạt động, mất mát hoặc hư hỏng tài sản, và/hoặc thương tích cá nhân. Bạn hoàn toàn chịu trách nhiệm về việc sử dụng bất kỳ công cụ hoặc đầu ra như vậy (bao gồm, không giới hạn, tính hợp pháp, phù hợp và kết quả của chúng).
...
Cảm ơn tất cả những người đóng góp đã giúp cải thiện Thea Code!
...
**Hãy tận hưởng Thea Code!** Cho dù bạn giữ nó trên dây ngắn hay để nó tự do hoạt động, chúng tôi rất mong được thấy những gì bạn xây dựng. Nếu bạn có câu hỏi hoặc ý tưởng về tính năng, hãy ghé qua [cộng đồng Reddit](https://www.reddit.com/r/thea-placeholder/) hoặc [Discord](https://discord.gg/thea-placeholder) của chúng tôi. Chúc lập trình vui vẻ!
