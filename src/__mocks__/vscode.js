...
const vscode = {
	...
	Position: class {
		...
		translate(lineDelta, characterDelta) {
			return new vscode.Position(this.line + (lineDelta || 0), this.character + (characterDelta || 0))
		}
	},
	Range: class {
		...
		with(start, end) {
			return new vscode.Range(start === undefined ? this.start : start, end === undefined ? this.end : end)
		}
	},
	Selection: class {
