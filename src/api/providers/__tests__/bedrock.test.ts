...
jest.mock("../../transform/neutral-bedrock-format", () => ({
	convertToBedrockConverseMessages: jest
		.fn()
		.mockReturnValue([{ role: "user", content: [{ text: "Test message" }] }]),
	convertToBedrockContentBlocks: jest.fn().mockReturnValue([{ text: "Test content" }]),
}))
