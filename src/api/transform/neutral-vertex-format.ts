 ...
 */
export function convertToVertexClaudeMessage(
 ...
 */
export function convertToVertexClaudeHistory(
 ...
 */
export function formatMessageForCache(
 ...
 */
export function convertToVertexGeminiMessage(
    neutralMessage: NeutralMessage
): Content {
 ...
 */
export function convertToVertexGeminiHistory(
    neutralHistory: NeutralConversationHistory
): Content[] {
 ...
 */
export function convertToVertexClaudeContentBlocks(
