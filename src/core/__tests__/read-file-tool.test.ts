...
describe("read_file tool with maxReadFileLine setting", () => {
	...
	const originalCountFileLines = jest.requireActual<typeof import("../../integrations/misc/line-counter")>(
		"../../integrations/misc/line-counter",
	).countFileLines
	const originalReadLines = jest.requireActual<typeof import("../../integrations/misc/read-lines")>(
		"../../integrations/misc/read-lines",
	).readLines
	const originalExtractTextFromFile = jest.requireActual<typeof import("../../integrations/misc/extract-text")>(
		"../../integrations/misc/extract-text",
	).extractTextFromFile
	const originalAddLineNumbers = jest.requireActual<typeof import("../../integrations/misc/extract-text")>(
		"../../integrations/misc/extract-text",
	).addLineNumbers
