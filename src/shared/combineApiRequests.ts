...
/**
 * Combines API request start and finish messages in an array of TheaMessages. // Renamed type in comment
 *
 ...
 * @returns A new array of TheaMessage objects with API requests combined.
 *
 * @example
 * const messages = [
