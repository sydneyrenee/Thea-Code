...
/**
 * Combines sequences of command and command_output messages in an array of TheaMessages. // Renamed type
 *
 ...
 * @returns A new array of TheaMessage objects with command sequences combined.
 *
 * @example
 * const messages: TheaMessage[] = [ // Renamed type
